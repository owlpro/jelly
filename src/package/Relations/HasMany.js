...
class HasMany extends Component {
    ...
    makeRenderableInputs(index) {
        ...
        return this.state.inputs.map((item, loopKey) => {
            ...
            switch (input.type) {
                case "text": return <React.Fragment key={loopKey}><SCText ref={el => this.elements[key][input.selector] = el} {...input} /></React.Fragment>;
                case "textarea": return <React.Fragment key={loopKey}><SCTextarea ref={el => this.elements[key][input.selector] = el} {...input} /></React.Fragment>;
                case "number": return <React.Fragment key={loopKey}><SCNumber ref={el => this.elements[key][input.selector] = el} {...input} /></React.Fragment>;
                case "select": return <React.Fragment key={loopKey}><SCSelect ref={el => this.elements[key][input.selector] = el} {...input} /></React.Fragment>;
                case "multiselect": return <React.Fragment key={loopKey}><SCMultiselect ref={el => this.elements[key][input.selector] = el} {...input} /></React.Fragment>;
                case "color": return <React.Fragment key={loopKey}><SCColor ref={el => this.elements[key][input.selector] = el} {...input} /></React.Fragment>;
                case "radio": return <React.Fragment key={loopKey}><SCRadio ref={el => this.elements[key][input.selector] = el} {...input} /></React.Fragment>;
                case "password": return <React.Fragment key={loopKey}><SCPassword ref={el => this.elements[key][input.selector] = el} {...input} /></React.Fragment>;
                case "birthday": return <React.Fragment key={loopKey}><SCBirthday ref={el => this.elements[key][input.selector] = el} {...input} /></React.Fragment>;
                case "map": return <React.Fragment key={loopKey}><SCMap ref={el => this.elements[key][input.selector] = el} {...input} /></React.Fragment>;
            ...
            if (index.id) {
                Dialog({
                    ...
                    onAccept: () => {
                        ...
                        this.props.deleteHasManyRelationItem({ route }, appendData).then(() => {
        ...
        if (index.__key__) return (
            <Fragment key={index.__key__}>
                <Row className="align-items-center">
                    ...
                    <Col xs={11}>
                        <Row>
                            {this.makeRenderableInputs(index)}
                        </Row>
                    </Col>
                </Row>
            </Fragment>
