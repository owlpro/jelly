                                ...
                                <Fragment>
                                    <div className="scimage_input_image_data_wrapper">
                                        {this.#isImage(this.state.file) ? (
                                            <Fragment>
                                                {/* <div className="scimage_input_image_selected_effect" style={{ backgroundImage: `url('${config.baseUrl + child.path}')` }}></div>
                                                <div className="scimage_input_image_selected_image">
                                                    <img src={config.baseUrl + child.path} />
                                                </div> */}
                                            </Fragment>
                                        ) : (
...
export default connect(null, mapDispatchToProps, null, { forwardRef: true })(SCImage);